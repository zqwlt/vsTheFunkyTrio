...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['what the fuck', 0.2], //From 0% to 19%
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'city': new states.stages.City(); //guy
			case 'city2': new states.stages.City2(); //hunk
			case 'club': new states.stages.Club(); //hunk
			case 'club2': new states.stages.Club2(); //hunk
		}
